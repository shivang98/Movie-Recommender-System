...
def recommend(request):
	...
	movie_list=set(Movie.objects.filter(myrating__user_id=user_id_similar_to_current_user_id,myrating__rating__gte=4))
	mv=set(Movie.objects.filter(myrating__user_id=current_user_id))
	movie_list=list(movie_list-mv)[:10]
